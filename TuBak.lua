...
local hash = database:sismember(bot_id.."TuBak:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevTuBak(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTuBak(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
if hash or DevTuBak(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTuBak(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTuBak(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTuBak(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevTuBak(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
elseif database:sismember(bot_id.."TuBak:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."TuBak:Basic:Constructor"..chat_id, user_id) then
...
for TuBak in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = TuBak
end
...
local TuBak_Msg = database:get(bot_id.."TuBak:Add:Filter:Rp2"..text..msg.chat_id_)   
if TuBak_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬| "..TuBak_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Basic:Constructor23"..msg.chat_id_, result.id_)
...
if database:get(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
database:set(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:TuBak:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:TuBak:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:TuBak:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:TuBak:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:TuBak:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:TuBak:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:TuBak:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:TuBak:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and DevTuBak(msg) then
 
local list = database:smembers(bot_id.."botss:TuBak:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:TuBak:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:TuBak:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:TuBak:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:TuBak:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"تم حذف ردود المتعدده")
end
if text == ("الردود المتعدده") and DevTuBak(msg) then
...
if text == "اضف رد متعدد" and DevTuBak(msg) then
 
database:set(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DevTuBak(msg) then
 
database:set(bot_id.."botss:TuBak:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:TuBak:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:TuBak:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:TuBak:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:TuBak:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:TuBak:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:TuBak:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:TuBak:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:TuBak:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:TuBak:Add:Rd:Sudo:Text2"..text)   
...
function Function_TuBak(extra, result, success)
database:sadd(bot_id.."TuBak:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TuBak:Basic:Constructor23"..msg.chat_id_, result.id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_TuBak, nil)
return false
end
------------------------------------------------------------------------
...
local list = database:smembers(bot_id.."TuBak:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TuBak:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TuBak:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔| قائمة المنع \n⎯ ⎯ ⎯ ⎯ \n"
for k,v in pairs(list) do  
local TuBak_Msg = database:get(bot_id.."TuBak:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TuBak_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TuBak:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TuBak:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TuBak:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TuBak:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TuBak:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TuBak:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TuBak:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:sismember(bot_id.."TuBak:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."TuBak:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."TuBak:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."TuBak:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
local UserName = (b.username_ or "VlVlVI")
...
if text == (database:get(bot_id.."TuBak:Name:Bot") or "توباك") then
Namebot = (database:get(bot_id.."TuBak:Name:Bot") or "توباك")
local namebot = {
...
if text == 'تفعيل تاك المشرفين' and Owner(msg) then   
database:del(bot_id..'tgg:bot:api'..msg.chat_id_) 
Text = '\n تم تفعيل التاك للمشرفين' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل تاك المشرفين' and Owner(msg) then  
database:set(bot_id..'tgg:bot:api'..msg.chat_id_,true) 
Text = '\n تم تعطيل التاك للمشرفين' 
send(msg.chat_id_, msg.id_,Text) 
end 
if text == 'تفعيل التاك' and Owner(msg) then   
database:del(bot_id..'tgs:bot:api'..msg.chat_id_) 
Text = '\n تم تفعيل التاك' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التاك' and Owner(msg) then  
database:set(bot_id..'tgs:bot:api'..msg.chat_id_,true) 
Text = '\n تم تعطيل التاك' 
send(msg.chat_id_, msg.id_,Text) 
end 
...
https.request('https://devstorm.ml/tshake.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
database:set(bot_id.."TuBak:klesh:id"..msg.chat_id_,Text_Rand)
...
local NumMsg = database:get(bot_id..'TuBak:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'TuBak:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text == ("عدد الميديا") and Owner(msg) then 
...
download_to_file('https://raw.githubusercontent.com/Pandatele/TuBak/main/TuBak.lua', 'TuBak.lua') 
download_to_file('https://raw.githubusercontent.com/Pandatele/TuBak/main/start.lua', 'start.lua') 
dofile('TuBak.lua')  
return false
end
...
local list1 = database:smembers('TuBak:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."TuBak:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('TuBak:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."TuBak:Constructor"..Groups[i], v)
end
local list3 = database:smembers('TuBak:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."TuBak:Manager"..Groups[i], v)
end
local list4 = database:smembers('TuBak:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."TuBak:Mod:User"..Groups[i], v)
end
database:set(bot_id.."TuBak:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'TuBak:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
...
database:set(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📫|  ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'TuBak:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
...
database:set(bot_id.."TuBak:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
local keyboard = {
{'تغيير المطور الاساسي','الاحصائيات 📊'},
...
local inline = {{{text="المطور",url="t.me/"..("U5UUUU")}}}
end
send_inline(msg.chat_id_, msg.id_, inline) 
end
end
database:setex(bot_id..'TuBak:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevTuBak(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if text =='تغيير المطور الاساسي' and DevTuBak(msg) then
send(msg.chat_id_, msg.id_,'ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'TuBak:Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي' and not DevTuBak(msg) then
send(msg.chat_id_, msg.id_,'تسرسح')
end
if database:get(bot_id.."TuBak:DevBots") then
if text and text:match("^(%d+)$") then
...
A:close()
database:del(bot_id.."TuBak:Ed:DevBots")
end
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*🚻| عدد المشتركين الان ~ '..#pv..'\nℹ️| تم العثور على ~ '..sendok..' مشترك قام بحظر البوت\n☑| اصبح عدد المشتركين الان ~ '..ok..' مشترك *')   
end
end
end,nil)
end,nil)
...
------------------------------------------------------------------------
if text == 'السيرفر' and DevTuBak(msg) then 
...
if database:get(bot_id.."TuBak:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id.."TuBak:admin:Time"..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local Name_Bot = (database:get(bot_id.."TuBak:Name:Bot") or "توباك")
...
------------------------------------------------------------------------
if text then
local TuBak_Msg = database:get(bot_id.."TuBak:Add:Filter:Rp2"..text..result.chat_id_)   
if TuBak_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬| "..TuBak_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
