...
local NameUser = "[- 𝙈𝙊𝙃𝘼𝙈𝙀𝘿 𝙍𝙎𝙃𝙀𝙀𝘿 𖡊 .](https://t.me/TuBaKx)\n — — — — — — — — —\n◐︙ بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- 𝙈𝙊𝙃𝘼𝙈𝙀𝘿 𝙍𝙎𝙃𝙀𝙀𝘿 𖡊 .](https://t.me/TuBaKx)\n — — — — — — — — —\n◐︙ اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if text == (database:get(bot_id.."TuBak:Name:Bot") or "محمد") then
Namebot = (database:get(bot_id.."TuBak:Name:Bot") or "محمد")
local namebot = {
...
if text == 'م1' or text == 'م2' or text == 'م3' or text == 'م4' or text == 'م5' and Addictive(msg) then     
local Texxxt = [[
اهلا عزيزي
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اضغط هنا للاوامر', callback_data="/help"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Texxxt).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Name_Bot = (database:get(bot_id.."TuBak:Name:Bot") or "محمد")
