...
if text == (database:get(bot_id.."TuBak:Name:Bot") or "تشاكيx") then
Namebot = (database:get(bot_id.."TuBak:Name:Bot") or "تشاكيx")
local namebot = {
...
https.request('https://devstorm.ml/TuBaks.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
🚩┇[ Tm  -  ”TuBak”](t.me/TuBak)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🦁┇[TuBak'X' TEAM](t.me/TuBak)

📂┇[Source Files](t.me/TuBak_files)

💠┇[instaBoT](t.me/VLVLVI)

📥┇[YouTube downloader](t.me/bhhBOT)

🔰┇[CHANNEL Tumblr](t.me/VLVLVI)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
[📮┇ConnectDeV](t.me/TuBakbbot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."TuBak:Name:Bot") or "تشاكيx")
