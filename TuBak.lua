...
io.popen("mkdir TuBak_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls TuBak_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."TuBak:Sudo:User", msg.sender_user_id_) 
if hash or Bot(msg) or DevTuBak(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevTuBak(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."TuBak:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevTuBak(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."TuBak:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTuBak(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."TuBak:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTuBak(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."TuBak:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevTuBak(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
...
function Vips(msg)
local hash = database:sismember(bot_id.."TuBak:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Bot(msg) or  DevTuBak(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
var = true
elseif DevTuBak(user_id) == true then
var = true
...
var = true  
elseif database:sismember(bot_id.."TuBak:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."TuBak:Basic:Constructor"..chat_id, user_id) then
var = true                 
elseif database:sismember(bot_id.."TuBak:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."TuBak:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TuBak:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TuBak:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TuBak:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(665877797) then  
var = "مطور السورس"  
elseif DevTuBake(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then  var = "المطور الاساسي²"  
elseif database:sismember(bot_id.."TuBak:Sudo:User", user_id) then
var = database:get(bot_id.."TuBak:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."TuBak:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."TuBak:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."TuBak:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."TuBak:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."TuBak:Manager"..chat_id, user_id) then
var = database:get(bot_id.."TuBak:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."TuBak:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."TuBak:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."TuBak:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."TuBak:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."TuBak:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."TuBak:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."TuBak:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."TuBak:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."TuBak:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."TuBak:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local NameUser = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
database:sadd(bot_id..'TuBak:Chek:Groups',idg) 
database:set(bot_id.."TuBak:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'TuBak:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."TuBak:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."TuBak:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."TuBak:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."TuBak:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."TuBak:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function TuBak_Files(msg)
for v in io.popen('ls TuBak_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("TuBak_Files/"..v)
if plugin.TuBak and msg then
pre_msg = plugin.TuBak(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function TuBak_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'TuBak:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'TuBak:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."TuBak:TuBak:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ≼≽ " then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء الاذاعه") 
database:del(bot_id.."TuBak:TuBak:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."TuBak:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'TuBak:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'TuBak:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'TuBak:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'TuBak:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."TuBak:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."TuBak:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TuBak:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."TuBak:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."TuBak:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."TuBak:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TuBak:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TuBak:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TuBak:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."TuBak:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."TuBak:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."TuBak:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."TuBak:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."TuBak:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."TuBak:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."TuBak:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."TuBak:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."TuBak:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."TuBak:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TuBak:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء وضع الوصف") 
database:del(bot_id.."TuBak:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."TuBak:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TuBak:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء حفظ الترحيب") 
database:del(bot_id.."TuBak:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TuBak:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."TuBak:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"≼≽ تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TuBak:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"≼≽ تم الغاء حفظ الرابط")       
database:del(bot_id.."TuBak:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."TuBak:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."TuBak:TuBak:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ≼≽ " then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء الاذاعه للخاص") 
database:del(bot_id.."TuBak:TuBak:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'TuBak:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."TuBak:TuBak:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ≼≽ " then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء الاذاعه") 
database:del(bot_id.."TuBak:TuBak:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."TuBak:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."TuBak:TuBak:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ≼≽ " then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء الاذاعه") 
database:del(bot_id.."TuBak:TuBak:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."TuBak:TuBak:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ≼≽ " then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء الاذاعه") 
database:del(bot_id.."TuBak:TuBak:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."TuBak:UsersBot")   
...
local TuBak_Msg = database:sismember(bot_id.."TuBak:List:Filter:text"..msg.chat_id_,text) 
if TuBak_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."TuBak:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."TuBak:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."TuBak:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
if database:get(bot_id.."TuBak:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ≼≽ " then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."TuBak:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TuBak:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."TuBak:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "≼≽ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."TuBak:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."TuBak:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"≼≽ ارسل الامر الجديد")  
database:del(bot_id.."TuBak:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."TuBak:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."TuBak:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."TuBak:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."TuBak:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."TuBak:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"≼≽ تم حفظ الامر")  
database:del(bot_id.."TuBak:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."TuBak:Lock:text"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الدردشه")  
return false
end 
if text == "قفل الاضافه" and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:set(bot_id.."TuBak:Lock:AddMempar"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل اضافة الاعضاء")  
return false
end 
if text == "قفل الدخول" and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:set(bot_id.."TuBak:Lock:Join"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل دخول الاعضاء")  
return false
end 
...
database:set(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل البوتات")  
return false
end 
if text == "قفل البوتات بالطرد" and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:set(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل البوتات")  
return false
end 
if text == "قفل الاشعارات" and msg.reply_to_message_id_ == 0 and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:tagservr"..msg.chat_id_,true)  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الاشعارات")  
return false
end 
...
database:set(bot_id.."TuBak:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."TuBak:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."TuBak:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل التثبيت هنا")  
return false
end 
...
database:set(bot_id.."TuBak:Lock:edit"..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل تعديل")  
return false
end 
...
database:set(bot_id.."TuBak:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'TuBak:'..lock..msg.chat_id_,"del")    
end
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل جميع الاوامر")  
return false
end 
--------------------------------------------------------------------------------------------------------------
if text == "فتح الاضافه" and msg.reply_to_message_id_ == 0 and Addictive(msg) then   
database:del(bot_id.."TuBak:Lock:AddMempar"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح اضافة الاعضاء")  
return false
end 
if text == "فتح الدردشه" and msg.reply_to_message_id_ == 0 and Owner(msg) then   
database:del(bot_id.."TuBak:Lock:text"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الدردشه")  
return false
end 
if text == "فتح الدخول" and msg.reply_to_message_id_ == 0 and Addictive(msg) then   
database:del(bot_id.."TuBak:Lock:Join"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح دخول الاعضاء")  
return false
end 
if text == "فتح البوتات" and msg.reply_to_message_id_ == 0 and Addictive(msg) then   
database:del(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فـتح البوتات")  
return false
end 
if text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Addictive(msg) then   
database:del(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."TuBak:Lock:tagservr"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فـتح الاشعارات")  
return false
end 
if text == "فتح التثبيت" and msg.reply_to_message_id_ == 0 and Constructor(msg) then   
database:del(bot_id.."TuBak:lockpin"..msg.chat_id_)  
database:srem(bot_id.."TuBak:Lock:pin",msg.chat_id_)
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فـتح التثبيت هنا")  
return false
end 
if text == "فتح التعديل" and msg.reply_to_message_id_ == 0 and Constructor(msg) then   
database:del(bot_id.."TuBak:Lock:edit"..msg.chat_id_) 
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فـتح تعديل")  
return false
end 
...
database:del(bot_id.."TuBak:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'TuBak:'..lock..msg.chat_id_)    
end
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فـتح جميع الاوامر")  
return false
end 
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."TuBak:Lock:Link"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الروابط")  
return false
end 
if text == "قفل الروابط بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Link"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الروابط")  
return false
end 
if text == "قفل الروابط بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Link"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الروابط")  
return false
end 
if text == "قفل الروابط بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Link"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الروابط")  
return false
end 
if text == "فتح الروابط" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Link"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الروابط")  
return false
end 
...
database:set(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل المعرفات")  
return false
end 
if text == "قفل المعرفات بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل المعرفات")  
return false
end 
if text == "قفل المعرفات بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل المعرفات")  
return false
end 
if text == "قفل المعرفات بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل المعرفات")  
return false
end 
if text == "فتح المعرفات" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح المعرفات")  
return false
end 
if text == "قفل التاك" and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل التاك")  
return false
end 
if text == "قفل التاك بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل التاك")  
return false
end 
if text == "قفل التاك بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل التاك")  
return false
end 
if text == "قفل التاك بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل التاك")  
return false
end 
if text == "فتح التاك" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح التاك")  
return false
end 
if text == "قفل الشارحه" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الشارحه")  
return false
end 
if text == "قفل الشارحه بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الشارحه")  
return false
end 
if text == "قفل الشارحه بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الشارحه")  
return false
end 
if text == "قفل الشارحه بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الشارحه")  
return false
end 
if text == "فتح الشارحه" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الشارحه")  
return false
end 
if text == "قفل الصور"and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Photo"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الصور")  
return false
end 
if text == "قفل الاباحي"and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Xn"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الاباحي")  
return false
end 
if text == "قفل الصور بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Photo"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الصور")  
return false
end 
if text == "قفل الصور بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Photo"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الصور")  
return false
end 
if text == "قفل الصور بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Photo"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الصور")  
return false
end 
if text == "فتح الصور" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Photo"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الصور")  
return false
end 
if text == "فتح الاباحي" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Xn"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الاباحي")  
return false
end 
if text == "قفل الفيديو" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Video"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الفيديو")  
return false
end 
if text == "قفل الفيديو بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Video"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الفيديو")  
return false
end 
if text == "قفل الفيديو بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Video"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الفيديو")  
return false
end 
if text == "قفل الفيديو بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Video"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الفيديو")  
return false
end 
if text == "فتح الفيديو" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Video"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الفيديو")  
return false
end 
if text == "قفل المتحركه" and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:Animation"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل المتحركه")  
return false
end
if text == "قفل المتحركه بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Animation"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل المتحركه")  
return false
end 
if text == "قفل المتحركه بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Animation"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل المتحركه")  
return false
end 
if text == "قفل المتحركه بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Animation"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل المتحركه")  
return false
end 
if text == "فتح المتحركه" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Animation"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح المتحركه")  
return false
end 
if text == "قفل الالعاب" and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:geam"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الالعاب")  
return false
end 
if text == "قفل الالعاب بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:geam"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الالعاب")  
return false
end 
if text == "قفل الالعاب بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:geam"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الالعاب")  
return false
end 
if text == "قفل الالعاب بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:geam"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الالعاب")  
return false
end 
if text == "فتح الالعاب" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:geam"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الالعاب")  
return false
end 
if text == "قفل الاغاني" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Audio"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الاغاني")  
return false
end 
if text == "قفل الاغاني بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Audio"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الاغاني")  
return false
end 
if text == "قفل الاغاني بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Audio"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الاغاني")  
return false
end 
if text == "قفل الاغاني بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Audio"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الاغاني")  
return false
end 
if text == "فتح الاغاني" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Audio"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الاغاني")  
return false
end 
if text == "قفل الصوت" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:vico"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الصوت")  
return false
end 
if text == "قفل الصوت بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:vico"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الصوت")  
return false
end 
if text == "قفل الصوت بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:vico"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الصوت")  
return false
end 
if text == "قفل الصوت بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:vico"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الصوت")  
return false
end 
if text == "فتح الصوت" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:vico"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الصوت")  
return false
end 
if text == "قفل الكيبورد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الكيبورد")  
return false
end 
if text == "قفل الكيبورد بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الكيبورد")  
return false
end 
if text == "قفل الكيبورد بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الكيبورد")  
return false
end 
if text == "قفل الكيبورد بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الكيبورد")  
return false
end 
if text == "فتح الكيبورد" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Keyboard"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الكيبورد")  
return false
end 
if text == "قفل الملصقات" and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الملصقات")  
return false
end 
if text == "قفل الملصقات بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الملصقات")  
return false
end 
if text == "قفل الملصقات بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الملصقات")  
return false
end 
if text == "قفل الملصقات بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الملصقات")  
return false
end 
if text == "فتح الملصقات" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Sticker"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الملصقات")  
return false
end 
if text == "قفل التوجيه" and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:forward"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل التوجيه")  
return false
end 
if text == "قفل التوجيه بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:forward"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل التوجيه")  
return false
end 
if text == "قفل التوجيه بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:forward"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل التوجيه")  
return false
end 
if text == "قفل التوجيه بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:forward"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل التوجيه")  
return false
end 
if text == "فتح التوجيه" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:forward"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح التوجيه")  
return false
end 
if text == "قفل الملفات" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Document"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الملفات")  
return false
end 
if text == "قفل الملفات بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Document"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الملفات")  
return false
end 
if text == "قفل الملفات بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Document"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الملفات")  
return false
end 
if text == "قفل الملفات بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Document"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الملفات")  
return false
end 
if text == "فتح الملفات" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Document"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الملفات")  
return false
end 
if text == "قفل السيلفي" and Addictive(msg) then  
database:set(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل السيلفي")  
return false
end 
if text == "قفل السيلفي بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل السيلفي")  
return false
end 
if text == "قفل السيلفي بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل السيلفي")  
return false
end 
if text == "قفل السيلفي بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل السيلفي")  
return false
end 
if text == "فتح السيلفي" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Unsupported"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح السيلفي")  
return false
end 
if text == "قفل الماركداون" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الماركداون")  
return false
end 
if text == "قفل الماركداون بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الماركداون")  
return false
end 
if text == "قفل الماركداون بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الماركداون")  
return false
end 
if text == "قفل الماركداون بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الماركداون")  
return false
end 
if text == "فتح الماركداون" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Markdaun"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الماركداون")  
return false
end 
if text == "قفل الجهات" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Contact"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الجهات")  
return false
end 
if text == "قفل الجهات بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Contact"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الجهات")  
return false
end 
if text == "قفل الجهات بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Contact"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الجهات")  
return false
end 
if text == "قفل الجهات بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Contact"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الجهات")  
return false
end 
if text == "فتح الجهات" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Contact"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الجهات")  
return false
end 
if text == "قفل الكلايش" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Spam"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الكلايش")  
return false
end 
if text == "قفل الكلايش بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Spam"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الكلايش")  
return false
end 
if text == "قفل الكلايش بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Spam"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الكلايش")  
return false
end 
if text == "قفل الكلايش بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Spam"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الكلايش")  
return false
end 
if text == "فتح الكلايش" and Addictive(msg) then  
database:del(bot_id.."TuBak:Lock:Spam"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الكلايش")  
return false
end 
if text == "قفل الانلاين" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفـل الانلاين")  
return false
end 
if text == "قفل الانلاين بالتقيد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفـل الانلاين")  
return false
end 
if text == "قفل الانلاين بالكتم" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفـل الانلاين")  
return false
end 
if text == "قفل الانلاين بالطرد" and Addictive(msg) then
database:set(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفـل الانلاين")  
return false
end 
if text == "فتح الانلاين" and Addictive(msg) then
database:del(bot_id.."TuBak:Lock:Inlen"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح الانلاين")  
return false
end 
if text == "قفل التكرار بالطرد" and Addictive(msg) then   
database:hset(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","≼≽ ️تم قفل التكرار")
return false
end 
if text == "قفل التكرار" and Addictive(msg) then   
database:hset(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"flood","del")  
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ ️تم قفل التكرار بالحذف")
return false
end 
if text == "قفل التكرار بالتقيد" and Addictive(msg) then   
database:hset(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","≼≽ ️تم قفل التكرار")
return false
end 
if text == "قفل التكرار بالكتم" and Addictive(msg) then   
database:hset(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","≼≽ ️تم قفل التكرار")
return false
end 
if text == "فتح التكرار" and Addictive(msg) then   
database:hdel(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"flood")  
Reply_Status(msg,msg.sender_user_id_,"unlock","≼≽ ️تم فتح التكرار")
return false
end 
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TuBak, nil)
return false 
end
...
if text == ("الثانويين") and DevTuBak(msg) then
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("مسح المطورين") and DevTuBak(msg) then
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
database:del(bot_id.."TuBak:Sudo:User")
...
database:del(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."TuBak:Constructor"..msg.chat_id_)
...
database:del(bot_id.."TuBak:Manager"..msg.chat_id_)
...
database:del(bot_id.."TuBak:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."TuBak:Special:User"..msg.chat_id_)
...
database:del(bot_id.."TuBak:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."TuBak:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n≼≽ تم مسح المحظورين")
end
if text == ("قائمه العام") and DevTuBak(msg) then
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
local list = database:smembers(bot_id.."TuBak:GBan:User")
t = "\n≼≽ قائمة المحظورين عام \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
if text == ("المطورين") and DevTuBak(msg) then
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
local list = database:smembers(bot_id.."TuBak:Sudo:User")
t = "\n≼≽ قائمة مطورين البوت \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."TuBak:Constructor"..msg.chat_id_)
t = "\n≼≽ قائمة المنشئين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TuBak:Manager"..msg.chat_id_)
t = "\n≼≽ قائمة المدراء \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TuBak:Mod:User"..msg.chat_id_)
t = "\n≼≽ قائمة الادمنيه \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TuBak:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."TuBak:Muted:User"..msg.chat_id_)
t = "\n≼≽ قائمة المكتومين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TuBak:Ban:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTuBak(msg) then
function Function_TuBak(extra, result, success)
...
database:sadd(bot_id.."TuBak:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevTuBak(msg) then
...
database:sadd(bot_id.."TuBak:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevTuBak(msg) then
...
database:sadd(bot_id.."TuBak:GBan:User", userid)
...
if text and text:match("^الغاء العام @(.*)$") and DevTuBak(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_TuBak(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","≼≽ تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."TuBak:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"≼≽ لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevTuBak(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."TuBak:GBan:User", userid)
Reply_Status(msg,userid,"reply","≼≽ تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTuBak(msg) then
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
function Function_TuBak(extra, result, success)
database:sadd(bot_id.."TuBak:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","≼≽ تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TuBak, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevTuBak(msg) then
...
database:sadd(bot_id.."TuBak:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevTuBak(msg) then
...
database:sadd(bot_id.."TuBak:Sudo:User", userid)
Reply_Status(msg,userid,"reply","≼≽ تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTuBak(msg) then
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","≼≽ تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TuBak, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevTuBak(msg) then
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevTuBak(msg) then
...
database:srem(bot_id.."TuBak:Sudo:User", userid)
...
database:sadd(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, userid)
...
database:sadd(bot_id.."TuBak:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Constructor"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","≼≽ تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TuBak, nil)
end
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","≼≽ تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"≼≽ لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."TuBak:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","≼≽ تم تنزيله من المنشئين")  
end
...
database:sadd(bot_id.."TuBak:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Manager"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:Manager"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:sadd(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Mod:User"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:sadd(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TuBak:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Special:User"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, userid)
...
if TuBakrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "U5UUUU")..")".."\n≼≽ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."TuBak:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif TuBakrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "U5UUUU")..")".."\n≼≽ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."TuBak:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif TuBakrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "U5UUUU")..")".."\n≼≽ تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."TuBak:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif TuBakrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "U5UUUU")..")".."\n≼≽ تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif TuBakrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "U5UUUU")..")".."\n≼≽ تم تنزيله من "..RTPA.." هنا\n")  
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if result.id_ then
local TuBakrt = database:get(bot_id.."TuBak:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if TuBakrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..result.title_.."](t.me/"..(text1[3] or "U5UUUU")..")".."\n≼≽ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."TuBak:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif TuBakrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..result.title_.."](t.me/"..(text1[3] or "U5UUUU")..")".."\n≼≽ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."TuBak:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif TuBakrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/U5UUUU)\n — — — — — — — — —\n≼≽ العضو -› ["..result.title_.."](t.me/"..(text1[3] or "U5UUUU")..")".."\n≼≽ تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."TuBak:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."TuBak:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TuBak:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Ban:User"..msg.chat_id_, userid)
...
send(msg.chat_id_, msg.id_, "≼≽ ️انا لست محظورا \n") 
return false 
end
database:srem(bot_id.."TuBak:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."TuBak:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:Muted:User"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'TuBak:TuBak:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'TuBak:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'TuBak:TuBak:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'TuBak:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","≼≽ تم قفـل الفشار")  
end
if text and database:get(bot_id..'TuBak:TuBak:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n≼≽ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'TuBak')..') '
...
if database:sismember(bot_id.."TuBak:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."TuBak:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."TuBak:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"≼≽ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"≼≽ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."TuBak:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"≼≽ تم وضع زمن التكرار ("..Num..")") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"≼≽ ارسل رابط المجموعه او رابط قناة المجموعه")
database:setex(bot_id.."TuBak:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."TuBak:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."TuBak:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"≼≽ تم تعطيل جلب رابط المجموعه") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."TuBak:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"≼≽ جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."TuBak:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."TuBak:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
local num = database:smembers(bot_id.."TuBak:allM"..msg.chat_id_)
...
database:set(bot_id.."TuBak:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."TuBak:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."TuBak:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."TuBak:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."TuBak:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."TuBak:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"≼≽ تم تفعيل ترحيب المجموعه") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."TuBak:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"≼≽ تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."TuBak:Get:Welcome:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"≼≽ تم ازالة ترحيب المجموعه") 
end
return false  
end
if text == "قائمه المنع" and Addictive(msg) then  
database:set(bot_id.."TuBak:Filter:msg",msg.chat_id_)
...
local listtext = database:smembers(bot_id.."TuBak:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."TuBak:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."TuBak:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."TuBak:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."TuBak:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."TuBak:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."TuBak:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."TuBak:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"≼≽ تم منع الكلمه بنجاح")  
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."TuBak:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."TuBak:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."TuBak:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."TuBak:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:set(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء منعها ")  
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."TuBak:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."TuBak:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."TuBak:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."TuBak:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."TuBak:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."TuBak:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "≼≽ تم الغاء حفظ القوانين") 
database:del(bot_id.."TuBak:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."TuBak:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."TuBak:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."TuBak:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."TuBak:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."TuBak:List:Cmd:Group:New"..msg.chat_id_.."")
t = "≼≽ قائمه الاوامر المضافه  \n — — — — — — — — — \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."TuBak:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."TuBak:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."TuBak:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."TuBak:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"≼≽ تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."TuBak:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"≼≽ الان ارسل لي الامر القديم ..")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."TuBak:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_TuBak(extra, result, success)
database:sadd(bot_id.."TuBak:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TuBak:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TuBak:MN:TF"..msg.chat_id_, userid)
...
function Function_TuBak(extra, result, success)
database:srem(bot_id.."TuBak:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_TuBak(extra, result, success)
if result.id_ then
database:srem(bot_id.."TuBak:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TuBak:MN:TF"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","≼≽ تم تنزيله من منظفيه المجموعه")  
return false
end

if text == "الصلاحيات" and Addictive(msg) then 
local list = database:smembers(bot_id.."TuBak:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."TuBak:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
database:del(bot_id.."TuBak:MN:TF"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "🗑 تم مسح  قائمة المنظفين  ")
end
if text == ("المنظفين") and Owner(msg) then  
local list = database:smembers(bot_id.."TuBak:MN:TF"..msg.chat_id_)
t = "\n≼≽ قائمة المنظفين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TuBak:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."TuBak:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."TuBak:Coomds"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"≼≽ تم مسح الصلاحيات")
end
if text and text:match("^اضف صلاحيه (.*)$") and Addictive(msg) then 
ComdNew = text:match("^اضف صلاحيه (.*)$")
database:set(bot_id.."TuBak:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."TuBak:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."TuBak:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."TuBak:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "≼≽ تم مسح الصلاحيه ") 
end
if database:get(bot_id.."TuBak:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء الامر ") 
database:del(bot_id.."TuBak:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."TuBak:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."TuBak:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."TuBak:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد المطور الى -› "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."TuBak:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد المنشئ الاساسي الى -› "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."TuBak:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد المنشئ الى -› "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."TuBak:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد المدير الى -› "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."TuBak:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد الادمن الى -› "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."TuBak:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد المميز الى -› "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."TuBak:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"≼≽ تم تغير رد العضو الى -› "..Teext)
end


if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."TuBak:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."TuBak:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."TuBak:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."TuBak:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."TuBak:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."TuBak:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."TuBak:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."TuBak:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."TuBak:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."TuBak:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."TuBak:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق ≼≽ "
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره ≼≽ "
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ≼≽ "
elseif database:get(bot_id.."TuBak:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") -› {"..db.."}\n"
end
...
local test = database:get(bot_id.."TuBak:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."TuBak:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."TuBak:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."TuBak:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."TuBak:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."TuBak:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."TuBak:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."TuBak:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."TuBak:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."TuBak:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."TuBak:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevTuBak(msg) then 
local list = database:smembers(bot_id.."TuBak:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."TuBak:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."TuBak:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."TuBak:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."TuBak:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."TuBak:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."TuBak:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."TuBak:Add:Rd:Sudo:File"..v)
database:del(bot_id.."TuBak:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."TuBak:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"≼≽ تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevTuBak(msg) then 
local list = database:smembers(bot_id.."TuBak:List:Rd:Sudo")
text = "\n≼≽ قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
if database:get(bot_id.."TuBak:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:stekr"..v) then
db = "ملصق ≼≽ "
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:Photo"..v) then
db = "صوره ≼≽ "
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:File"..v) then
db = "ملف ≼≽ "
elseif database:get(bot_id.."TuBak:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") -› {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."TuBak:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."TuBak:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."TuBak:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."TuBak:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."TuBak:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."TuBak:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."TuBak:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."TuBak:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."TuBak:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"≼≽ تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevTuBak(msg) then 
send(msg.chat_id_, msg.id_,"≼≽ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevTuBak(msg) then 
send(msg.chat_id_, msg.id_,"≼≽ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."TuBak:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '≼≽ الان ارسل الرد الذي تريد اضافته \n≼≽ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n≼≽ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."TuBak:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."TuBak:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."TuBak:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TuBak:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"≼≽ تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'TuBak:'..v..text)
end
database:del(bot_id.."TuBak:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."TuBak:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."TuBak:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'TuBak:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."TuBak:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."TuBak:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."TuBak:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."TuBak:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."TuBak:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."TuBak:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."TuBak:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."TuBak:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."TuBak:Sudo:User",result.sender_user_id_) then
dev = "≼≽ تم تنزيله من المطورين"
else 
dev = "≼≽ هو ليس مطور" 
end
if database:sismember(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "≼≽ تم تنزيل من الاساسيين" 
else 
crr = "≼≽ هو ليس منشئ اساسي" 
end
if database:sismember(bot_id.."TuBak:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "≼≽ تم تنزيله من المنشئين" 
else 
cr = "≼≽ هو ليس منشئ" 
end
if database:sismember(bot_id.."TuBak:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "≼≽ تم تنزيله من المدراء" 
else 
own = "≼≽ هو ليس مدير" 
end
if database:sismember(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "≼≽ تم تنزيله من الادميه"
 else 
mod = "≼≽ هو ليس ادمن" 
end
if database:sismember(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_) then
...
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."TuBak:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."TuBak:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."TuBak:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TuBak:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."TuBak:User:Name"..v.user_id_) then
t = t.."≼≽ "..x.."[@"..database:get(bot_id.."TuBak:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if not database:get(bot_id.."TuBak:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."TuBak:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."TuBak:Kick:Me"..msg.chat_id_,true)  
Text = "\n≼≽ تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_TuBak(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."TuBak:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."TuBak:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."TuBak:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_TuBak(extra, result, success)
if database:sismember(bot_id.."TuBak:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."TuBak:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."TuBak:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."TuBak:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."TuBak:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
database:sadd(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."TuBak:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"≼≽ تم مغادرة المجموعه") 
database:srem(bot_id.."TuBak:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."TuBak:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevTuBak(msg) then   
database:del(bot_id.."TuBak:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"≼≽ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevTuBak(msg) then  
database:set(bot_id.."TuBak:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "≼≽ تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."TuBak:Name:Bot") or "بلاك") then
Namebot = (database:get(bot_id.."TuBak:Name:Bot") or "بلاك")
local namebot = {
...
if DevTuBak(msg) then
database:setex(bot_id.."TuBak:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."TuBak:Status:Bc") and not DevTuBak(msg) then 
send(msg.chat_id_, msg.id_,"≼≽ الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."TuBak:TuBak:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."TuBak:TuBak:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"≼≽ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n≼≽ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."TuBak:TuBak:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"≼≽ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n≼≽ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."TuBak:TuBak:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."TuBak:TuBak:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"≼≽ ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevTuBak(msg) then  
database:del(bot_id.."TuBak:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n≼≽ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevTuBak(msg) then  
database:set(bot_id.."TuBak:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n≼≽ تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."TuBak:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."TuBak:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."TuBak:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."TuBak:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."TuBak:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."TuBak:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."TuBak:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."TuBak:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."TuBak:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."TuBak:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."TuBak:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."TuBak:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n≼≽ ااعدادات المجموعه "..
"\n — — — — — — — — — "..
"\n≼≽ علامة ال {✓} تعني مفعل"..
...
if Owner(msg) then
database:del(bot_id.."TuBak:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '≼≽ تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."TuBak:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"≼≽ تم الغاء تعين الايدي") 
database:del(bot_id.."TuBak:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TuBak:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."TuBak:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
...
local Add_Mem = database:get(bot_id.."TuBak:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."TuBak:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'TuBak:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'TuBak:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'TuBak:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
local Id = data.id_
local NumMsg = database:get(bot_id..'TuBak:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'TuBak:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."TuBak:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'TuBak:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'TuBak:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '≼≽ عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'TuBak:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '≼≽ تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'TuBak:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '≼≽ عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'TuBak:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '≼≽ تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."TuBak:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '≼≽ عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'TuBak:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."TuBak:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."TuBak:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."TuBak:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevTuBak(msg) then
local pv = database:smembers(bot_id..'TuBak:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'TuBak:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevTuBak(msg) then
local group = database:smembers(bot_id..'TuBak:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'TuBak:Chek:Groups',group[i])  
w = w + 1
end
...
os.execute('wget https://raw.githubusercontent.com/Pandatele/TuBak/main/TuBak.lua')
os.execute('wget https://raw.githubusercontent.com/Pandatele/TuBak/main/start.lua')
dofile('TuBak.lua')  
return false
end
if text == "راسلني" then
...
database:set(bot_id.."TuBak:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الزخرفه')
database:set(bot_id.."TuBak:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."TuBak:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TuBak:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الابراج')
database:set(bot_id.."TuBak:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."TuBak:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TuBak:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل حساب العمر')
database:set(bot_id.."TuBak:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."TuBak:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TuBak:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."TuBak:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TuBak:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TuBak:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الافلام')
database:set(bot_id.."TuBak:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."TuBak:movie_bot"..msg.chat_id_) == "open" then
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."TuBak:Lock:Xn"..msg.chat_id_)=="del" then      
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."TuBak:Lock:Xn"..msg.chat_id_)=="del" then
...
if text == 'تفعيل البوت الخدمي' and DevTuBak(msg) then  
database:del(bot_id..'TuBak:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'≼≽ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevTuBak(msg) then  
database:set(bot_id..'TuBak:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'≼≽ تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTuBak(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'TuBak:Num:Add:Bot',Num) 
...
if text == 'جلب نسخه احتياطيه' and DevTuBak(msg) then
local list = database:smembers(bot_id..'TuBak:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'TuBak Chat'
ASAS = database:smembers(bot_id.."TuBak:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."TuBak:Constructor"..v)
MDER = database:smembers(bot_id.."TuBak:Manager"..v)
MOD = database:smembers(bot_id.."TuBak:Mod:User"..v)
link = database:get(bot_id.."TuBak:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"TuBak":"'..NAME..'",'
else
t = t..',"'..v..'":{"TuBak":"'..NAME..'",'
...
if text == 'نقل الاحصائيات' and DevTuBak(msg) then
local Users = database:smembers('TuBak:'..bot_id.."userss")
local Groups = database:smembers('TuBak:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'TuBak:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'TuBak:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'≼≽ تم نقل : '..#Groups..' كروب\n≼≽ تم نقل : '..#Users..' مشترك \n≼≽ من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevTuBak(msg) then
database:del(bot_id..'TuBak:Text_Dev')
send(msg.chat_id_, msg.id_,'≼≽ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevTuBak(msg) then
database:set(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'≼≽ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'≼≽ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TuBak:Text_Dev',text)
database:del(bot_id..'TuBak:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'≼≽ تم حفظ كليشة المطور')
return false
end
if text == 'رفع النسخه الاحتياطيه' and DevTuBak(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevTuBak(msg) then
dofile("TuBak.lua")  
send(msg.chat_id_, msg.id_, "≼≽ تم التحديث")
end
...
database:del(bot_id.."TuBak:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."TuBak:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."TuBak:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'TuBak:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'TuBak:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."TuBak:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."TuBak:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."TuBak:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."TuBak:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."TuBak:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'TuBak:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'TuBak:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."TuBak:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."TuBak:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."TuBak:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
database:set(bot_id.."TuBak:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."TuBak:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."TuBak:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."TuBak:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."TuBak:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:srem(bot_id..'TuBak:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:del(bot_id..'TuBak:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n🔽| تم تعطيل تحقق' ) 
end
if text == 'تفعيل التحقق' and Addictive(msg) then  
database:set(bot_id..'TuBak:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\n🔽| تم تفعيل تحقق' ) 
end 

if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'TuBak:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'TuBak:Num:Add:Bot') or 0) and not DevTuBak(msg) then
send(msg.chat_id_, msg.id_,'≼≽ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'TuBak:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'TuBak:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'≼≽ المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','≼≽ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'TuBak:Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'TuBak:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'TuBak:Free:Add:Bots') then  
local url,res = https.request('https://anashtick.ml/TuBak.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.TuBak ~= true then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ~ [@TuBakX]⚜️')   
...
Reply_Status(msg,result.id_,'reply_Add','≼≽ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'TuBak:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'TuBak:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
local list = database:smembers(bot_id.."TuBak:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."TuBak:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."TuBak:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if DevTuBak(msg) and msg.reply_to_message_id_ ~= 0  then    
...
inline = {
{{text = '≼≽ BLacK 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/U5UUUU'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."TuBak:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."TuBak:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."TuBak:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."TuBak:List:Filter:Sticker"..idchci,Sticker)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."TuBak:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."TuBak:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."TuBak:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."TuBak:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."TuBak:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."TuBak:List:Filter:Photo"..delallph,v)  
end  
end
end
if (data.ID == "UpdateNewMessage") then
...
if text and not database:sismember(bot_id..'TuBak:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'TuBak:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'TuBak:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."TuBak:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."TuBak:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."TuBak:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."TuBak:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."TuBak:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."TuBak:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."TuBak:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."TuBak:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."TuBak:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."TuBak:Name:Bot") or "بلاك")
if not database:get(bot_id.."TuBak:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
TuBak_Started_Bot(msg,data)
TuBak_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'TuBak:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."TuBak:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."TuBak:Basic:Constructor"..msg.chat_id_)
t = "≼≽ المنشئين الاساسين تعالو مخرب \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TuBak:User:Name" .. v)
...
if database:get(bot_id.."TuBak:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."TuBak:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."TuBak:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."TuBak:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local TuBak_Msg = database:sismember(bot_id.."TuBak:List:Filter:text"..result.chat_id_,text) 
if TuBak_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."TuBak:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."TuBak:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."TuBak:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'TuBak:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'TuBak:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'TuBak:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
